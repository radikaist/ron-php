...
### 6. Update File `app/Views/layouts/footer.php`
Di sini kita letakkan penutup kerangka dan semua *script* JavaScript yang dibutuhkan (jQuery, Bootstrap, dan AdminLTE).
